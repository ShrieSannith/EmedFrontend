      ...
      >
        ...
        <Grid container spacing={2}>
          {products.map((product, index) => {
            // Format the product name for the URL (lowercase and hyphen-separated)
            const formattedProductName = product.toLowerCase().replace(/\s+/g, "-");
            return (
              <Grid
                item
              ...
              >
                <Link
                  href={`/products/${formattedProductName}`}
                  underline="hover"
                  sx={{
